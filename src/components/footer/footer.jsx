                ...
                <Row className="py-5 align-items-center">
                    ...
                    <Col xs={12} md={4} className="d-flex justify-content-center mb-3">
                        <ul className="links d-flex flex-column flex-md-row gap-md-4 ">
                            <li>
                                <a href="https://wa.me/5517988245969?text=Ol%C3%A1%2C%20quero%20agendar%20um%20hor%C3%A1rio"
                                   target="_blank">
                                    Agendar Agora
                                </a>
                            </li>
                    ...
                    <Col xs={12} md={4}
                        ...
                        <p className="creditos mb-0">
                            &copy; {new Date().getFullYear()} UniBarretos. Todos os direitos reservados.
                        </p>
                    </Col>

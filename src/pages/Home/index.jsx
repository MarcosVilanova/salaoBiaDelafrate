...
function Home() {
    ...
    return (
        <>
            {/* Seção de Início com imagem de fundo e botões de ação */}
            <section className="card cardInicio">
                ...
                >
                    ...
                    <div className="d-flex flex-md-row flex-column gap-4 mt-2">
                        <Button
                        ...
                        <Button
                            href="https://wa.me/5517988245969?text=Ol%C3%A1%2C%20gostaria%20de%20tirar%20uma%20d%C3%BAvida%20ou%20pedir%20um%20or%C3%A7amento%20sobre%20os%20servi%C3%A7os%20do%20sal%C3%A3o."
                            target="_blank"
                            className="btn_inicio"
                        >
                            Orçamento / Duvidas
            ...
            {/* Seção Sobre Nós com texto e imagens */}
            <Container className="linhaVertical" data-aos="fade-up">
            ...
            {/* Seção Antes e Depois com carrossel de imagens */}
            <Container className="linhaVertical" data-aos="fade-up">
            ...
            {/* Seção de Avaliações das clientes */}

...
function Home() {
    ...
    return <>
        ...
        <Container className="mt-4 linhaVertical" data-aos="fade-up">
            <h2 className="titulo display-5">Serviços</h2>
            <Swiper
                slidesPerView={4}
        ...
        <Container className="linhaVertical" data-aos="fade-up">
            <h2 className="titulo display-5">Antes e Depois</h2>
            ...
            >
                {dataTransformacao.map((item) => <SwiperSlide key={item.id}>
                    <Card className="cardAntesDepois ">
                        ...
                        <Swiper
                            slidesPerView={1}
                            navigation pagination={{"clickable": true}} className="swiperInterno">
                            {item.images.map((img, index) => (<SwiperSlide key={index}>
                                <Card.Img src={img.src} alt={"Card Antes/Depois"}
                                          className="imgCardAntesDepois" loading="lazy"/>
        ...
        {/* AVALIAÇÕES */}
        <Container className="linhaVertical mb-5">
            <h2 className="display-5 mt-4 mb-4 titulo">O que dizem nossas clientes</h2>
            <Swiper
                slidesPerView={4}
                pagination={{"clickable": true}}
                breakpoints={{
